...
PROJECT = {
  "code": "I-12",
  "slug": "school-inventory-dashboard-python",
  "title": "School Inventory Dashboard Python",
  "kind": "inventory_dashboard",
  "description": "Synthetic equipment inventory dashboard with status metrics by lab, charts, and HTML report export."
}
